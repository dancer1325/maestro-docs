...
The following table lists common selector properties. For a complete list of all available selectors, see the [Selectors](../../flows/flow-control-and-logic/how-to-use-selectors.md) documentation.
