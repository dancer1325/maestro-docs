...
certain testing scenarios require complex logic that goes beyond simple linear steps
* The JavaScript integration allows you to make use of a full-scale scripting engine directly from your Flows, enabling you to handle dynamic data, complex assertions, and external integrations.

### Why use JavaScript in your Flows?

JavaScript provides the flexibility needed to create resilient, data-driven tests without sacrificing the stability
...
To ensure that tests remain portable and secure, Maestro executes JavaScript in a restricted sandbox
* This means the scripts run in a "clean" environment without direct access to your local file system or external Node.js libraries
* This architecture ensures that a Flow written on one machine will behave identically on a teammate's computer or in Maestro Cloud.
...
* Maestro discourage the Rhino usage.
{% endhint %}
...
* [run-and-debug-javascript.md](run-and-debug-javascript.md "mention"): Maestro provides three ways to run JavaScript
* You can also use standard `console.log` statements to debug your logic during execution.
* [manage-data-and-states.md](manage-data-and-states.md "mention"): The global `output` object allows you to share data across your entire Flow
* This ensures that a value captured or generated in one script can be used by any subsequent YAML command or JavaScript expression.
