...
* **Maestro Studio**: Always use [Maestro Studio](../../../../maestro-studio/README.md) to inspect SwiftUI views. It helps you see exactly how the nested view composition is resolved by the accessibility tree before you write your YAML.
