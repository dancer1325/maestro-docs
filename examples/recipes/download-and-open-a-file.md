...
* [Selectors](../../flows/flow-control-and-logic/how-to-use-selectors.md): Learn how to use selectors to make your text assertions more flexible.
* [Conditions](../../flows/flow-control-and-logic/conditions.md): See how to use `visible` and `notVisible` to handle branching UI logic.
